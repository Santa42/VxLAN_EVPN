В первой части цикла статей по технологии VxLAN EVPN хочу рассмотреть технологии и способ организации L2 связанности между 
...
Это проблама - BUM(Broadcast, Unknown Unicast, Multicast) трафик. В рамках этой статьи рассмотрим вариант борьбы с broadcast трафиком.
...
Все довольно просто, EVPN route-type помимо MAC адреса может передавать связу MAC/IP. Для этого на Leaf необходимо настроить IP
адрес в VLAN. Появляется один вопрос, какой IP задать. На nexus есть возможность создать распределнный(одинаковый) адрес на всех коммутаторах:
